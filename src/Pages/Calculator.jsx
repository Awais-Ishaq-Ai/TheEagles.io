...
const Calculator = () => {
  ...
  return (
    <div className='bg-black text-white p-2 py-5'>
      <div className='text-center'>
        ...
        <p className='my-5 w-[70%] mx-auto text-[13px] text-[#A7A7A7]'>
        ...
        <div className='bg-gradient-to-r from-[#000000] to-[#747474] w-3/4 mx-auto flex items-center justify-center px-8 py-3 mt-4 text-textColor3 font-medium rounded-lg'>
          <button>x4</button>
        </div>
      </div>
      <div className='bg-[#FFFFFF1F] text-white my-5 py-3'>
        <div className='flex items-center px-3'>
          <h3 className='p-2 bg-[#4531FB] rounded-full px-3'>x3</h3>
          <h3 className='ml-5'>The Eagles.io</h3>
        </div>
        <p className='text-[13px] text-[#A7A7A7] mt-3 px-3'>
        ...
        <p className='text-[13px] text-[#A7A7A7] mt-3 mb-2 px-3'>
          Cost of all selected slots
        </p>
        <h2 className='text-[#FFFFFF] font-semibold px-3'>{value} BUSD</h2>
        <hr />
        <p className='text-[13px] text-[#A7A7A7] mt-3 px-3'>
          Result of all selected
        </p>
        <h2 className='text-[#FFFFFF] text-2xl font-semibold px-3'>
          {value} BUSD
        </h2>
      </div>
    </div>
